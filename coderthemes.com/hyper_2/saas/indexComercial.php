<?php
/* SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES  - INDAIATUBA 26JAN23
   SISTEMA DESARROLLADO  POR FRANCO VIEIRA MORALES - INDAIATUBA 26JAN23
   SYSTEM DEVELOPED BY FRANCO VIEIRA MORALES       - INDAIATUBA 26JAN23


   ULTMA ALTERAÇÃO - FRANCO VIEIRA MORALES - INDAIATUBA 02FEV23 - RES000101/13BR  
            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="#" class="side-nav-link"><!-- apps-calendar.html -->
                        ...
                        <li class="side-nav-item">
                            <a href="#" class="side-nav-link"><!-- apps-chat.html  -->
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="comercial/form-wizard-orcamento.php">Orçamentos</a>
                                    </li>
                                    <li>
                                        <a href="#">Produtos</a><!-- apps-ecommerce-products.html -->
                                    </li>
                                    <li>
                                        <a href="http://www.indafire.ind.br/indatec/coderthemes.com/hyper_2/saas/comercial/apps-ecommerce-products-details.php">Detalhes Produtos</a><!-- apps-ecommerce-products-details.html -->
                                    </li>
                                    <li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEmail">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="#">Inbox</a><!-- apps-email-inbox.html -->
                                    </li>
                                    <li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarTables">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="#">Tabelas Basicas</a><!-- tables-basic.html  -->
                                    </li>
                                    <li>
                                        <a href="#">Tabela de Dados</a><!-- tables-datatable.html  -->
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarMaps">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="#">Google Maps</a><!--maps-google.html  -->
                                    </li>
                                    <li>
                                        <a href="#">Vetor Maps</a><!-- maps-vector.html  -->
                                    </li>
                                </ul>
                            </div>
                        </li>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <?php $num = mysqli_query($con,"SELECT * FROM t0013");
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Numero de Pedidos">Pedidos</h5>
                                                <?php $ped = mysqli_query($con,"SELECT * FROM relatorio WHERE relMes = '$mes'"); 
