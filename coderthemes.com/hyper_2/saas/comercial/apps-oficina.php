...
/*###########################################################################*/
/* ###  ARQUIVO DE PEDIDOS PARA A OFICINA/ LISTA  -  SISTEMA DE INDATEC  ### */
/*###########################################################################*/
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
        ...
        <script type="text/javascript">
             ...
             // ## CONFIRMAÇÃO PARA APAGAR ORDEM ## //
            function apagar()
            {   
                 createRequest();
                 var url = "apagar_pedido.php?orc="+escape('X');
                  ...
                  if(request.readyState == 4)
                  {
                      if(request.status == 200)
                      {
                          if(request.responseText == 0)
                          {
                               ...
                               document.getElementById('excessao').innerHTML = "<div class='alert alert-success excessao-entrar'>ATENÇÃO: ERRO AO APAGAR ORDEM !!</div>";
                               setTimeout(function(){document.getElementById("excessao").innerHTML = ""},1000);
                          }
                          else
                          {   
                              //  REGISTRO REMOVIDO  //
                              document.getElementById('excessao').innerHTML = "<div class='alert alert-success excessao-entrar'>ATENÇÃO: ORDEM REMOVIDA COM SUCESSO!!</div>";
            ...
            // ## INICIO DE ROTINA PARA APAGAR TODO A ORDEM ## //
            function del(v)
            {
             ...
             // ## INICIO DE ROTINA PARA EDITAR ORDEM ## //
            function editfile(e)
            {
                 var ordem = e;
                 createRequest();
                 var url = "http://www.indafire.ind.br/indatec/coderthemes.com/hyper_2/saas/oficina/ordem_salvar.php?ordem="+escape(ordem);
                 request.open("GET",url,true);
                 request.onreadystatechange = function(){
                  if(request.readyState == 4)
                  {
                      if(request.status == 200)
                      {
                          ...
                          {   
                              window.location.href="http://www.indafire.ind.br/indatec/coderthemes.com/hyper_2/saas/oficina/form-oficina.php";
                          }
                      }
                  }};
                  request.send(null);
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="content">
<!--  ##############################################################################################################################################################################################  -->
                <!-- ATENÇÃO - ATENÇÃO - AQUI COMEÇA O MODAL PARA MENSAGEM DE APAGAR ORDEM DE SERVIÇO ##### -->
                        ...
                        <div class="modal-content">
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    ...
                                    <h4 class="mt-2">Deseja apagar esta ordem?</h4>
                                    
                                    <button type="button" class="btn btn-warning my-2" data-bs-dismiss="modal" onclick="apagar_ordem()">Sim</button>
...
<!--  ##############################################################################################################################################################################################  -->
                <!-- ATENÇÃO - ATENÇÃO - AQUI COMEÇA O MODAL PARA MENSAGEM DE NOVA ORDEM ##### -->
                <!-- ALERTA MODAL DE AVISO -->
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    <i class="dripicons-warning h1 text-warning"></i>
                                    <h4 class="mt-2">Deseja abrir uma nova ordem?</h4>
                                    
                                    <button type="button" class="btn btn-warning my-2" data-bs-dismiss="modal" onclick="nova_ordem()">Sim</button>
                                    <button type="button" class="btn btn-warning my-2" data-bs-dismiss="modal">Não</button>
                                </div>
                            </div>
                        </div><!-- /.modal-content -->
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Lista Oficina</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Lista Oficina</h4><span id="excessao"></span>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody><?php $num = mysqli_query($con,"SELECT PED_NUM_PED, PED_DAT_ABER_PED, PED_EMAIL_CLI_PED, PED_STATUS_PED FROM t0019 WHERE PED_DAT_ABER_PED = '$dataCompleta' ORDER BY PED_NUM_PED ASC"); 
                                                             while($num3 = mysqli_fetch_array($num))   { ?>
                                                    <tr>
                                                        <td>
                                                            <div class="form-check">
                                                        ...
                                                        <td><a class="text-body fw-bold"><?php print $num3['PED_NUM_PED']; $numero = $num3['PED_NUM_PED'];  ?></a> </td>
                                                        <td>
                                                            <?php print $num3['PED_DAT_ABER_PED'];  ?> <small class="text-muted"><?php print $num3[''] ?></small>
                                                        </td>
                                                        <td>
                                                            <h5><span class="badge badge-success-lighten"><i class="mdi mdi-bitcoin"><?php print $num3['PED_EMAIL_CLI_PED'] ?></i></span></h5>
                                                        </td>
                                                        <td>
                                                          <?php total($numero);?>
                                                        </td>
                                                        <td>
                                                            <h5><span class="badge badge-info-lighten"><?php print $num3['PED_STATUS_PED'];  ?></span></h5>
                                                        </td>
                                                        <td>
                                                            <a href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <a href="javascript:void(0);" class="action-icon" onclick="editfile(e = '<?php print $num3['PED_NUM_PED']; ?>')"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="javascript:void(0);" class="action-icon"  onclick="del(v = '<?php print $num3['PED_NUM_PED']; ?>')"> <i class="mdi mdi-delete"></i></a>
                                                        </td>
                                                    </tr><?php } 
                                                    // ## FUNÇÃO PARA CARREGAR O VALOR TOTAL DO PEDIDO NA TELA ## //
                                                        function total($numero)
                                                        {
                                                             require 'inc/conexao.php';

                                                             // ## QUERY PARA CARREGAR GRID ## //
                                                             $tab = mysqli_query($con,"SELECT sum(PED_ITEM_TOTAL_ITEM) AS TOTAL FROM t0020 WHERE PED_ITEM_NUM_PED = '$numero'");
