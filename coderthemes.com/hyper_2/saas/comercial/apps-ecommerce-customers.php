<?php
/* SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES  - INDAIATUBA 26OUT22
   SISTEMA DESARROLLADO  POR FRANCO VIEIRA MORALES - INDAIATUBA 26OUT22
   SYSTEM DEVELOPED BY FRANCO VIEIRA MORALES       - INDAIATUBA 26OUT22
...
$cli = mysqli_query($con,"SELECT CLI_COD_CLI, CLI_RAZ_SOC_CLI, CLI_FONE_CLI, CLI_EMAIL_CONT_CLI, CLI_CID_CLI, CLI_DAT_CRIA_CLI FROM t0013 ORDER BY CLI_COD_CLI LIMIT 1000");
...
<!-- Mirrored from coderthemes.com/hyper_2/saas/apps-ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Dec 2021 14:42:03 GMT -->
<head>
        <meta charset="utf-8" />
        ...
        function apagar_cliente()
        {
             ...
             createRequest();
             var url = "apagar_cliente.php?numero="+escape(0);
             ...
             request.onreadystatechange = function(){
              if(request.readyState == 4)
              {
                  if(request.status == 200)
                  {
                      ...
                      {   
                          //  REGISTRO REMOVIDO  //
                          document.getElementById('excessao').innerHTML = "<div class='alert alert-success excessao-entrar'>ATENÇÃO: CLIENTE REMOVIDO COM SUCESSO!!</div>";
       ...
       // ## FUNÇÃO PARA APAGAR CLIENTE ## //
        function del(v)
        {    var numero = v; // RECEBENDO O NUMERO DO CLIENTE QUE VEM DO PARAMETRO PARA CARREGAR NA FUNÇÃO APÓS A JANELA ALERTA //
        ...
        // ## FINAL DE ROTINA ## //
         ...
         // ## FUNÇÃO PARA APONTAR PARA A PÁGNA DE CADASTRO DO CLIENTE ## //
        function edit(v)
        {    var num = v; // RECEBENDO O NUMERO DO CLIENTE //
             window.location.href="http://www.indafire.ind.br/indatec/coderthemes.com/hyper_2/saas/cadastros/form-elements.php?num="+escape(num);
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="apps-ecommerce-products-details.php">Detalhes Produtos</a><!-- apps-ecommerce-products-details.html -->
                                    </li>
                                    <li>
                        ...
                        <div class="modal-content">
                            <div class="modal-body p-4">
                                <div class="text-center">
                                    ...
                                    <button type="button" class="btn btn-warning my-2" data-bs-dismiss="modal" onclick="apagar_cliente()">Sim</button>
                                    <button type="button" class="btn btn-warning my-2" data-bs-dismiss="modal">Não</button>
                                </div>
                            </div>
                        </div><!-- /.modal-content -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Clientes</h4><span id="excessao"></span>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="http://www.indafire.ind.br/indatec/coderthemes.com/hyper_2/saas/cadastros/form-elements.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Adicionar Cliente</a>
                                            </div>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-striped dt-responsive nowrap w-100" id="products-datatable">
                                                ...
                                                <tbody><?php while($_cli = mysqli_fetch_array($cli)) {  ?>
                                                    <tr>
                                                        <td>
                                                            <div class="form-check">
                                                        ...
                                                        <td class="table-user">
                                                            ...
                                                            <a href="javascript:void(0);"  onclick="edit(v = <?php print $_cli['CLI_COD_CLI'];?>)"><?php print utf8_encode($_cli['CLI_RAZ_SOC_CLI']);  ?></a>
                                                        </td>
                                                        <td>
                                                            <?php print $_cli['CLI_FONE_CLI'];  ?>
                                                        </td>
                                                        <td>
                                                           <?php print $_cli['CLI_EMAIL_CONT_CLI'];  ?>
                                                        </td>
                                                        <td>
                                                            <?php print $_cli['CLI_CID_CLI'];  ?>
                                                        </td>
                                                        <td>
                                                            <?php print $_cli['CLI_DAT_CRIA_CLI']; ?>
                                                        </td>
                                                        <td>
                                                            <span class="badge badge-success-lighten">Ativo</span>
                                                        </td>
                    
                                                        <td>
                                                            <a href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="javascript:void(0);" class="action-icon" onclick="del(v = '<?php print $_cli['CLI_COD_CLI']; ?>')"> <i class="mdi mdi-delete"></i></a>
                                                        </td>
                                                    </tr> <?php  }  ?>
                                                </tbody>
                                            </table>
